...
//    static let profilePhoto = Logger(subsystem: subsystem, category: "\(category).profilePhoto")
//    static let alert        = Logger(subsystem: subsystem, category: "\(category).alert")
//    static let defaults     = Logger(subsystem: subsystem, category: "\(category).defaults")
//    static let settings     = Logger(subsystem: subsystem, category: "\(category).settings")
//    static let location     = Logger(subsystem: subsystem, category: "\(category).location")
...
//    static let tag          = Logger(subsystem: subsystem, category: "\(category).tag")
//    static let log          = Logger(subsystem: subsystem, category: "\(category).log")
//    static let appDelegate  = Logger(subsystem: subsystem, category: "\(category).appDelegate")
//
